# What is this?
First of all, this is a work in progress to make up for the fact that for several years, most of the code and software that I have been developing exists under different, company-owned github accounts. That work covers everything from Ai, computer vision, network services, data visualization and processing platforms, encrypted communications, streaming, etc... I'll need to produce some toy examples to illustrate that experience. Here is where I'll be doing that.
